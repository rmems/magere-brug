use super::{
    ...
    apply_emit::{
        emit_base_dir, emit_file_name, prepare_emit_tree, reject_registration_path_collisions,
        write_emitted_manifest, write_regular_file_under_base,
    },
    resolve::reference_is_manifest_path,
};
